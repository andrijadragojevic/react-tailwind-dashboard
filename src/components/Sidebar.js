...
import { FaBolt, FaChevronLeft, FaChevronRight, FaRegSun, FaTachometerAlt, FaWrench } from "react-icons/fa"
  ...
  return (
    <div className='bg-[#4E73DF] h-screen px-[25px] '>
        ...
        <div className='bg-[#395CBF] mt-[15px] flex items-center justify-center flex-col py-[15px] px-[10px] gap-[15px] rounded-[3px]'>
            <FaBolt color='white' />
            <p className='text-[12px] leading-[18px] font-normal text-white/[0.4] text-center'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus, sit cupiditate.</p>
